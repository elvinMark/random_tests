...
class LambSAM(Optimizer):
    """
    Implementing LAMB + SAM (to improves the calculation of the w_adv)"""
    ...
    def __init__(
        ...
        if nesterov and (momentum <= 0 or dampening != 0):
            raise ValueError("Nesterov momentum requires a momentum and zero dampening")
        super(LambSAM, self).__init__(params, defaults)
